...
Pymthouse embeds the clearinghouse package at `POST /webhooks/remote-signer`. The same package runs as a standalone sidecar in the clearinghouse compose stack.
