...
## Pattern 1: SaaS app — per-user sessions {#pattern-1-saas-app-per-user-sessions}
...
## Pattern 2: CLI tool — device flow {#pattern-2-cli-tool-device-flow}
...
## Pattern 3: Metered billing — charge users {#pattern-3-metered-billing-charge-users}
