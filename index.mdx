...
<CardGroup cols={2}>
  ...
  <Card title="App manifest" icon="list-check" href="/integration/manifest">
    Network capability manifest — discoverable pipeline/model combinations with ETag caching.
  </Card>
</CardGroup>
